...
async def on_message(message):
    ...
    if message.author != client.user:
        ...
        if msg_lower.startswith("!price "):
            await moduuli.current_price(message, keywords_lower, client)
            ...
            await moduuli.hae_wikista(message, keywords_lower, client)
        ...
        elif msg_lower.startswith("!ehp ") or msg_lower.startswith("!ironehp ") or msg_lower.startswith("!skillerehp "):
            await moduuli.ehp_laskuri(message, keywords_lower, client)
            ...
            await moduuli.hinnanmuutos(message, keywords_lower, client)
